...
function oxi_addons_smooth_scrolling_settings() {
    //register our settings
    register_setting('oxi-addons-smooth_scrolling-group', 'oxi_addons_smooth_scrolling');
    register_setting('oxi-addons-smooth_scrolling-group', 'oxi_addons_smooth_scrolling_post');
    register_setting('oxi-addons-smooth_scrolling-group', 'oxi_addons_smooth_scrolling_page');
    register_setting('oxi-addons-smooth_scrolling-group', 'oxi_addons_smooth_scrolling_offset');
}

add_action('admin_init', 'oxi_addons_smooth_scrolling_settings');
